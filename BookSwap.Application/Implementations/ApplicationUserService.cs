...
using BookSwap.Infrastructure.Extention;
...
namespace BookSwap.Application.Implemetations
{
    public class ApplicationUserService : IApplicationUserService
    {
        ...
        public async Task<Result> Registersync(AddUserDto userDtos)
        {
            ...
            try
            {
                ...
                if(!await _emailService.SendEmailConfirmationAsync(user.Email, user.Id.ToString(), code))
                {
                    ...
                    return Result.BadRequest("Faild Send Email Confrimation");
                }
        ...
        public async Task<Result<string>> ChangePasswordAsync(ChangeUserPassword changeUserPassword)
        {
            //get user
        ...
        public async Task<Result> UpdateUserAsync(UpdateUserDto userDtos)
        {
            //check if user is exist
        ...
        public async Task<Result<IEnumerable<GetUsersDto>>> GetUsersAsync()
        {
